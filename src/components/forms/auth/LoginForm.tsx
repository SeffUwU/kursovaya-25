...
import { getDictionary } from '@/helpers/dictionary/dictionary.helper';
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="email">{t.capitalizedWords.phone}</Label>
            <Input
              id="phone"
              type="phone"
          ...
          <div className="space-y-2">
            <Label htmlFor="password">{t.capitalizedWords.phone}</Label>
            <Input
              id="password"
              type="password"
              required
